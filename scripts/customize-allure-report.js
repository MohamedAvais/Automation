...
function appendBrandingCss(css) {
  ...
  const brandingBlock = `${marker}\n.side-nav{width:345px!important;}\n.side-nav__head{margin:16px 0!important;padding:0 12px 18px!important;}\n.side-nav__brand{background:url("${logoTargetName}") no-repeat center 12px!important;background-size:190px auto!important;display:flex!important;flex-direction:column!important;justify-content:flex-end!important;align-items:center!important;font-size:45px!important;font-weight:450!important;line-height:48px!important;margin:0!important;min-height:164px;padding:126px 8px 0!important;text-align:center!important;white-space:nowrap!important;}\n.side-nav__brand-text{display:block!important;max-width:100%!important;overflow:visible!important;text-overflow:clip!important;padding:0!important;}\n.side-nav_collapsed{width:64px!important;}\n.side-nav_collapsed .side-nav__brand{background-position:center 8px!important;background-size:30px auto!important;min-height:46px!important;padding:0!important;}\n`;
...
function appendSingleFileBranding(html, logoDataUri, iconDataUri) {
  ...
  const brandingCss = `.side-nav{width:345px!important;}\n.side-nav__head{margin:16px 0!important;padding:0 12px 18px!important;}\n.side-nav__brand{background:url("${logoDataUri}") no-repeat center 12px!important;background-size:190px auto!important;display:flex!important;flex-direction:column!important;justify-content:flex-end!important;align-items:center!important;font-size:45px!important;font-weight:450!important;line-height:48px!important;margin:0!important;min-height:164px!important;padding:126px 8px 0!important;text-align:center!important;white-space:nowrap!important;}\n.side-nav__brand-text{display:block!important;max-width:100%!important;overflow:visible!important;text-overflow:clip!important;padding:0!important;}\n.side-nav_collapsed{width:64px!important;}\n.side-nav_collapsed .side-nav__brand{background-position:center 8px!important;background-size:30px auto!important;min-height:46px!important;padding:0!important;}`;
