...
test("TC_06_To_Verify_that_error_message_when_pushing_GEO_data_to_Salesforce_with_missing_or_inaccessible_External_ID", async ({ page }) => {
  ...
  await test.step('Open Data for Salesforce and verify the GEO push error workflow', async () => {
    ...
    await digiteyescampsDataforsalesforceHelpers.expectGEOErrorMessage(page);
  });
